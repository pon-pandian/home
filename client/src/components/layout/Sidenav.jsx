  ...
  return (
    <>
      ...
      {!login ? ( <>
        ...
        <Menu.Item key="1">
          <NavLink to="/foods" style={{ textDecoration: 'none' }}>
            <span
              className="icon"
              style={{
                background: page === "foods" ? color : "",
              }}
            >
              {foods}
            </span>
            <span className="label">Our Foods</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="2">
      ...
      token.token.role === "super-admin" ? (<>
        <Menu.Item key="6">
          <NavLink to="/super-admin-dashboard" style={{ textDecoration: 'none' }}>
            <span
              className="icon"
              style={{
                background: page === "super-admin-dashboard" ? color : "",
              }}
            >
              {superAdminDash}
            </span>
        ...
        <Menu.Item key="7">
          <NavLink to="/add-admin" style={{ textDecoration: 'none' }}>
            <span
              className="icon"
              style={{
                background: page === "add-admin" ? color : "",
              }}
            >
              {AddAdmin}
            </span>
        ...
        <Menu.Item key="9">
          <NavLink to="/admin-addfood" style={{ textDecoration: 'none' }}>
            <span
              className="icon"
              style={{
                background: page === "admin-addfood" ? color : "",
              }}
            >
              {AdminAddFood}
            </span>
            <span className="label">Add Food</span>
          </NavLink>
        </Menu.Item>
        </>)}
      ...
      {login && <div className="aside-footer">
        <div
        ...
        >
          ...
          <h6>Tasty food for every mood...</h6>
          <p></p>
